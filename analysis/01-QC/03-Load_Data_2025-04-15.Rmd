...
# save the annotation to a rds file
saveRDS(annotation, file = here::here("data","reference","annotations_ATAC.rds"))
...
counts.CTRL <- Read10X_h5(here::here("data","raw-data", "cellrange-arc-out",
                                    "PSZ-6","filtered_feature_bc_matrix.h5"))
seurat.CTRL <- CreateSeuratObject(counts = counts.psz$`Gene Expression`,
                                 assay = "RNA",project = "CTRL")
